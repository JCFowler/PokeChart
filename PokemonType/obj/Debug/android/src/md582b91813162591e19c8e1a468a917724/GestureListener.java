...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("PokemonType.GestureListener, PokemonType, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", GestureListener.class, __md_methods);
	}
	...
	public GestureListener () throws java.lang.Throwable
	{
		...
		if (getClass () == GestureListener.class)
			mono.android.TypeManager.Activate ("PokemonType.GestureListener, PokemonType, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
